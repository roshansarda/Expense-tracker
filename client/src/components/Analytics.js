...
const Analytics = ({ allTransection }) => {
  ...
  const totalTurnover = allTransection.reduce(
    (acc, transaction) => acc + transaction.amount,  // reduce function iterates over all the income and add it in acc
    0
  );
            ...
            <div className="card-body">
              ...
              <div className="d-flex flex-column align-items-center">
                <Progress
                  ...
                  strokeColor={"green"}
                  className="mx-2"
                  percent={totalIncomePercent.toFixed(0)}  // to show the round figure
                />
                <Progress
                  type="circle"
                  strokeColor={"red"}
